...
public class HistoryTripsViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Trip> tripList;
    private Activity currentActivity;
    public HistoryTripsViewAdapter(FragmentActivity activity, List<Trip> tripList) {
